...
["lead and call atomic",o.includes("const [,storedCall] = await prisma.$transaction([")],["call in transaction",o.includes("prisma.call.create({")],
["execution key stored",o.includes("executionKey,")],["attribution after stored call",o.indexOf("const [,storedCall]")<o.indexOf("recordCallAttribution")],
...
["campaign failure finalized",o.includes('status:"FAILED",callsMade,endedAt:new Date()')],["campaign failure bounded",o.includes('error:"Campaign execution failed."')],
...
["network before DB transaction",o.indexOf("placeConversationalCall")<o.indexOf("const [,storedCall]")],["no executable mutation",!o.includes("eval(")],
