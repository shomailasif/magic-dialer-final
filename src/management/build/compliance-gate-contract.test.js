...
const checks=[
 ...
 ["pre-dial decision exists",orch.includes("decideCallCompliance({doNotCall:lead.doNotCall")],
 ["suppression occurs before SIP",orch.indexOf("decideCallCompliance")<orch.indexOf("makeSIPCall(")],
