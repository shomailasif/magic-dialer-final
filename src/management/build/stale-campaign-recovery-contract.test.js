...
["recovery before foundation",o.indexOf("const staleBefore")<o.indexOf("const foundation = await ensureSalesFoundation")],["recovery runs before empty due return",o.indexOf("staleBefore")<o.indexOf("dueLeads.length===0")],
