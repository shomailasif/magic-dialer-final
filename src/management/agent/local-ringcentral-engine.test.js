...
assert(webui.includes("function escapHtml(v)") && !webui.includes("async function escapHtml(v)"), "call error HTML escaping must be synchronous so Promise objects cannot leak into rendered errors");
